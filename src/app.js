...
app.get('/artist/:id', artistControllers.getArtistById); // find an artist by id
app.patch('/artist/:id', artistControllers.updateArtist); // updating the information of the artist
app.delete('/artist/:id', artistControllers.deleteArtist); // deleting an artist 
